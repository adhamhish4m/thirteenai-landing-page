      ...
      <div className="relative z-10">
        ...
        <section className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            <div className="glass-strong p-8 sm:p-10 rounded-2xl border-2 border-primary/30">
              {/* Title */}
              <h2 className="text-3xl sm:text-4xl font-bold text-center mb-2 text-white">
                AGA Pilot Program
              </h2>
              <p className="text-center text-lg text-muted-foreground mb-8">90 Days</p>

              {/* Value Stack */}
              <div className="mb-8 space-y-3">
                <div className="flex justify-between items-center text-base sm:text-lg">
                  <span className="text-foreground">ICP Strategy Workshop</span>
                  <span className="text-muted-foreground">$300</span>
                </div>
                <div className="flex justify-between items-center text-base sm:text-lg">
                  <span className="text-foreground">Campaign Copy (2 sequences)</span>
                  <span className="text-muted-foreground">$1,800</span>
                </div>
                <div className="flex justify-between items-center text-base sm:text-lg">
                  <span className="text-foreground">Verified Lead Database</span>
                  <span className="text-muted-foreground">$1,000</span>
                </div>
                <div className="flex justify-between items-center text-base sm:text-lg">
                  <span className="text-foreground">AI Enrichment & Personalization</span>
                  <span className="text-muted-foreground">$450</span>
                </div>
                <div className="flex justify-between items-center text-base sm:text-lg">
                  <span className="text-foreground">Technical Setup & Launch</span>
                ...
                <div className="border-t border-white/10 pt-3 mt-3">
                  <div className="flex justify-between items-center text-lg sm:text-xl">
                    ...
                    <span className="line-through text-muted-foreground">$3,650</span>
                  </div>
                </div>
              </div>
              ...
              <div className="text-center mb-6">
                <div className="text-2xl sm:text-3xl font-bold text-white mb-2">
                  Setup Fee: <span className="text-primary">$1,497</span>
                </div>
                <div className="text-xl sm:text-2xl font-bold text-primary mb-4">
                  Save $2,153 (59% OFF)
                </div>
                <div className="text-base sm:text-lg text-muted-foreground">
                  + $250-450 per qualified meeting (based on deal size)
                </div>
              </div>
              ...
              <div className="glass-card p-6 rounded-xl mb-6 border border-primary/20">
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <span className="text-foreground">First meeting within 30 days or full refund</span>
                  </div>
                  <div className="flex items-start gap-2">
                    <span className="text-primary text-lg">✓</span>
                    <span className="text-foreground">Expected: 5-8 meetings in 90 days</span>
                  </div>
                </div>
              </div>
              ...
              <button
                onClick={handleBookCall}
                className="w-full inline-flex items-center justify-center rounded-md text-lg sm:text-xl font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-14 sm:h-16 px-8"
              >
                Book a Quick Chat
              </button>
            </div>
